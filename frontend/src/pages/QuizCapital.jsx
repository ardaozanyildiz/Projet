...
function QuizCapital() {
  ...
  const loadAllQuestions = async () => {
    try {
      const result = await axios.get('http://10.10.2.125:8888/questions/getByCategory/capitale');
  ...
  if (currentQuestionIndex >= tabQuestions.length) {
    return (
      <div className='quiz'>
        ...
        <Link to="/Resultat/capitale"><button className="bouton" style={{ background: "blue", color: "white", marginLeft: "44%" }}>Voir les résultats de votre quiz</button></Link>
